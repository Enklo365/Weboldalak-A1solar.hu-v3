  ...
  return (
    ...
    <section className="w-full">
      ...
      <div className="lg:hidden">
        {/* Rounded hero card (no sharp polygon cut) — matches the desktop's
            rounded-panel language. */}
        <div className="px-4">
          <div
            className="relative flex min-h-[340px] flex-col justify-end overflow-hidden rounded-[24px] p-6 text-white"
            style={{
